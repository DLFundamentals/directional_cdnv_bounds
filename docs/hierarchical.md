...
<figure>
	<img src="../git_figures/vicreg_hierarchical.png" alt="Illustration of the hierarchial clustering experiment for VicReg" width="600"/>
	<figcaption>
		<strong>Figure:</strong> Illustration of the hierarchical clustering experiment for VicReg. Each fine-grained class is mapped to one of 10 superclasses, and CDNV dynamics are tracked at both label granularities during training.
	</figcaption>
</figure>